...
func NewTracerWithObjs(resolver IPResolver, connections IEbpfMap, probes MyProbes) LinksTracer {
	return LinksTracer{
		ebpfObjects: probes,
...
// TracesPollingIteration a single polling from the eBPF maps
